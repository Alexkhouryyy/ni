...
const MODE = MODES[0]; // Focus

export const MS_Focus: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 16, color: MODE.color, letterSpacing: '0.15em', textTransform: 'uppercase', fontWeight: 600, marginBottom: 8 }}>
          {MODE.tag}
        </div>
        <div style={{ fontSize: 72, fontWeight: 800, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1 }}>
          {MODE.name}
        </div>
      </div>
      ...
      <div style={{
        ...
        fontSize: 26, color: '#6b7280', fontWeight: 300, textAlign: 'center', marginBottom: 56,
      }}>
        {MODE.tagline}
      </div>
      ...
      {/* Chat demo */}
      <div style={{
        display: 'flex', flexDirection: 'column', gap: 18, width: '100%', maxWidth: 900,
      }}>
      ...
      {/* Insight */}
      <div style={{ opacity: insightOpacity, fontSize: 20, color: '#4b5563', fontStyle: 'italic', marginTop: 40 }}>
        {MODE.insight}
      </div>
