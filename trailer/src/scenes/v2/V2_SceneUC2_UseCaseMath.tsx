...
const ChatBubble: React.FC<{
  ...
  translateX: number;
  accentColor?: string;
}> = ({ text, isUser, opacity, translateX, accentColor = '#34d399' }) => {
  return (
    <div style={{
      opacity,
...
export const V2_SceneUC2_UseCaseMath: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        />
        <ChatBubble
          text="What is the formula for n! in terms of (n−1)!?"
          isUser={false}
        ...
        />
        <ChatBubble
          text="n! = n × (n−1)!... so 1! = 1 × 0!... which means 0! = 1."
          isUser={true}
        ...
        />
        <ChatBubble
          text="You just proved it. No lecture required."
          isUser={false}
